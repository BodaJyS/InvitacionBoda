...
const invitaciones = [
    { nombre: "Familia Pinto Chavez", totalInvitados: 7 },
    { nombre: "Lizbeth Pinto", totalInvitados: 2 },
    { nombre: "Sergio y Karina", totalInvitados: 2 },
    { nombre: "Yessenia Pinto", totalInvitados: 1 },
    { nombre: "Esposos Martinez Hernandez", totalInvitados: 2 },
    { nombre: "Andrea Linarez e Hijos", totalInvitados: 3 },
    { nombre: "Familia Hernandez Linares", totalInvitados: 3 },
    { nombre: "Esposos Linares Mendez", totalInvitados: 2 },
    { nombre: "Sergio y Caroll", totalInvitados: 2 },
    { nombre: "Familia Mendez Gonzalez", totalInvitados: 4 },
    { nombre: "Familia Calderon Mendez", totalInvitados: 4 },
    { nombre: "Haroldo Mendez", totalInvitados: 1 },
    ...
    { nombre: "Erick Martinez y Pareja", totalInvitados: 2 },
    { nombre: "Andre Alvarado y Pareja", totalInvitados: 2 },
    ...
    { nombre: "Dulce Velasquez", totalInvitados: 1 },
    { nombre: "Familia Hidalgo Figueroa", totalInvitados: 4 },
    { nombre: "Familia Agustin Argueta", totalInvitados: 3 },
    { nombre: "Nelson y Maritza", totalInvitados: 2 },
    { nombre: "Leonardo y Sulma", totalInvitados: 2 },
    { nombre: "Familia Agustin Carrillo", totalInvitados: 3 },
    ...
    { nombre: "Luis Godinez y Pareja", totalInvitados: 2 },
    { nombre: "Familia Valdez Perez", totalInvitados: 3 },
    { nombre: "Maria Figueroa", totalInvitados: 1 },
